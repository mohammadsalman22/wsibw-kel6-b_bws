          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$_SESSION['nama']."(".$_SESSION['login'].")";?></span>
...
<div class="col-xl-12 col-lg-7">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-item-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Diskon Harga</h6>
    ...
    <div class="card-body">
      <!-- <form action="">
        ...
        <div class="form-group">
          <input type="number" name="diskon" id="name" class="form-control form-control-user" 
