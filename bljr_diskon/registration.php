            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <form action="">
                  ...
                  <div class="form-group">
                    <input type="password" name="password" id="id" class="form-control form-control-user" placeholder="Password Anda" required>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <textarea name="biografi" id="controlTextArea" rows="4" class="form-control" placeholder="Biografi" required></textarea>
                    </div>
                  ...
                  if($jenka){
                    echo "<strong>Jenis kelamin: </strong> {$jenka} <br>";
                  }
                  if($agama){
