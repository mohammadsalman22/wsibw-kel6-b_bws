      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="input_wisata.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> + Tambah Data Baru</a>
          </div>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <img width="300px" height="200px"  src="../assets/images/<?php echo $data['gambar_wisata']; ?>">
                            </td>
                            <td><?php echo $data['deskripsi_wisata']; ?></td>
                            <td class="text-right">Rp.<?php echo number_format($data['harga_wisata'],2) ; ?></td>
                            <td>
                              <a href="edit_wisata.php?id=<?php echo $data['id_wisata']; ?>" class="btn btn-warning">Edit</a><hr>
                              <a href="hapus_wisata.php?id=<?php echo $data['id_wisata']; ?>" class="btn btn-danger">Hapus</a>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
