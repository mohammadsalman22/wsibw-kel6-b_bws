  ...
  <form action="simpan.php" method="POST">
    <table>
      <tr>
        <td>NIM</td>
        <td>:</td>
        <td><input type="text" name="ta" placeholder="nim" onKeyDown="textCounter(this.form.ta,this.form.countDisplay);" onKeyUp="textCounter(this.form.ta,this.form.countDisplay);"></td>
      </tr>
      <tr>
        <td>NAMA</td>
        <td>:</td>
    ...
    <h3 style="margin-top: 30px;">Tabel Mahasiswa</h3>
    <table width='80%' border=1>
      <tr>
        <th>No</th> <th>NIM</th> <th>Nama</th> <th>Tanggal Lahir</th> <th>Agama</th> <th>Username</th> <th>Password</th>
      </tr>
    <?php  
      $no=1;
...
<form>
      ...
      <select name="nim">
        <option value=""></option>
          <?php 
            ...
            while($user_data = mysqli_fetch_array($result)){
              ?>
                <option value="<?=$user_data['nim']?>"><?=$user_data['nim']." - ".$user_data['nama']?></option>
          <?php
        }
       ?>
      </select>
    ...
    <?php 
      if (isset($_GET['nim'])) {
        if ($_GET['nim']!="") {
          $result = mysqli_query($mysqli,"SELECT * FROM mahasiswa WHERE nim='".$_GET['nim']."'");
          $user_data = mysqli_fetch_assoc($result);
          ?>
          <form>
          <h3>Data Mahasiswa</h3>
            <input type="text" name="nim" placeholder="nim" disabled value="<?=$user_data['nim']?>"><br>
